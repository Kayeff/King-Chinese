...
export default function MenuGrid({ itemName, itemPrice, img }) {
  return (
    <div className="w-full border border-prussian-blue/20 p-2 grid grid-cols-1 gap-2 bg-black text-chilli-red">
      <img src={img} alt="" />
      <h1 className="w-full text-base text-center font-medium font-gang-of-three">
        Veg. {itemName}
      </h1>
      <div className="flex items-center justify-center space-x-3 font-switzer">
